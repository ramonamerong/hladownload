...
* ```python -m hladownload``` When this or an OS equivelant command is run in a folder with the files of this repository, the command line program can be used without any further installation.
